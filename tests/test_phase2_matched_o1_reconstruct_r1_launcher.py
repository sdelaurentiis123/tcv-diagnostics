"""Static safety locks for the six-checkpoint matched O1 reconstruction job."""
...
LAUNCHER = ROOT / "cluster/phase2_matched_o1_reconstruct_r1.sbatch"
MANIFEST = ROOT / "paper0/manifests/phase2_matched_o1_r1_reconstruction.json"
LOCKED = (
    ROOT / "paper0/results/phase2_o1_codec_r1_freeze_6894300.json",
