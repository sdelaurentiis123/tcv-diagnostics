...
//
// Potential-to-vorticity forward-closure oracle for selected native-81
// TCV/Hermes 85604 states. The metric normalization, runtime pressure, and
...
int main(int argc, char** argv) {
  ...
  for (std::size_t position = 0; position < EXPECTED_FRAMES.size();
    ...
    output["forward_u_" + label] = forward_input;
  ...
  output["paper0_oracle_name"] =
      "phase2_potential_vorticity_forward_85604";
