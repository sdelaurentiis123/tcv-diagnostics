#!/usr/bin/env python3
"""Generate frozen M32 forecasts for one completed PGL variogram arm."""
...
def main() -> int:
    ...
    if paths["model_dataset"] != args.artifact_root.resolve(strict=True):
        raise ValueError("variogram forecast artifact root differs")
    training = authorize_variogram_training_result(
    ...
    variogram_provenance = load_variogram_checkpoint_state(
    ...
    spec = WandbRunSpec(
        ...
        job_type="old-85604-pgl-variogram-M32-generation",
        tags=("paper0", "85604", "pgl-variogram", f"arm-{args.arm}", "M32"),
    )
    ...
    run = wandb.init(
        ...
        tags=list(spec.tags),
        config={
            "scope": "old_85604_pgl_variogram_truth_free_generation",
            "arm": args.arm,
            "paper0_commit": args.paper0_commit,
            "manifest_sha256": args.manifest_sha256,
            "training_result_sha256": args.training_result_sha256,
            "checkpoint_sha256": args.checkpoint_sha256,
            "physics_derived_training_loss_used": args.arm in ("C", "D"),
    ...
    try:
        ...
        result = {
            **generation,
            "scope": "old_85604_pgl_variogram_truth_free_forecast_generation",
            ...
            "provenance": {
                ...
                "variogram_warm_start": variogram_provenance,
            },
